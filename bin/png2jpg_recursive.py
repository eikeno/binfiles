...
def usage() -> None:
	print(
		...
		Wilk look recursively under TOP_DIR for PNG files and convert
		them to JPG.
		""" % (os.path.basename(__file__))
		)
	)

def walkdir(start_path: str, callable: Callable) -> None:
